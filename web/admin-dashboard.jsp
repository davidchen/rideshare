...
<% String pageTitleName = "Admin Dashboard"; %>
    ...
    <div class="row content-row">
        <div class="col-12">
            <div class="text-center">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createSyssupModal">
                    Create a system support user
                </button>
            ...
            <!-- Create sys support modal -->
            <div class="modal fade" id="createSyssupModal" tabindex="-1" role="dialog"
                 aria-labelledby="createSyssupModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="createSyssupModalLabel">
                        ...
                        <div class="modal-body">
                            <%@ include file="/partials/create-syssup-form.jsp" %>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="queryModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%@ include file="/partials/query-stats-form.jsp" %>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="row mt-5">
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-sm"
                               style="max-width: none; word-wrap: break-word; table-layout: fixed;">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Company</th>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAdModal">Add
                            an
                            ad
                        </button>
                    </div>
            ...
            <div class="col-12">
                <div class="row mt-5">
                    ...
                    <div class="col-12">
                        <h4 class="text-center"><strong>User Payouts</strong></h4>
                    </div>


                    <div class="col-12">

                        <% ArrayList<ArrayList<String>> pays = (ArrayList) pageContext.getAttribute("payout_list");
                            if (pays.isEmpty()) { %>
                        <p class="text-center">There are no payouts to show.</p>
                        <% } else { %>
